...
IMAGE_PROMPT_SOURCE_FILES = {
    ...
    "image_5_0_unified": IMAGE_PROMPT_SOURCE_ROOT / "image-5-0-unified.md",
...
# The durable Native audit projection is valid for every public Native route,
# not only the historical Image 3.0 route.
NATIVE_PUBLIC_AUDIT_RUN_STRATEGIES = frozenset({"image_3_0", "image_5_0"})
...
def native_public_audit_marker_for_run_slide(run_slide_id: int) -> dict | None:
    ...
    if (
        ...
        or slide.get("run_strategy") not in NATIVE_PUBLIC_AUDIT_RUN_STRATEGIES
    ):
        return None
