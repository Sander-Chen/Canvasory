...
the fixed Public Image PPT 5.0 workflow.
"""
...
version = \"0.1.0\"
description = \"Thin CLI control plane for Public Image PPT 5.0\"
...
def _populate_runtime(repo_root: Path, app_root: Path) -> None:
    ...
    for relative in _PUBLIC_ALLOWLIST.required_runtime_source_paths():
