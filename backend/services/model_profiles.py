...
NATIVE_IMAGE_5_0_ROUTE = "image_5_0"
...
# The single fixed public Image 5.0 combination: the existing Sol Low director
# also serves as the palette extractor, and the existing Luna Low launcher owns
# the image generator binding.  It introduces no new profile tier.
NATIVE_IMAGE_5_0_SOL_DIRECTOR_CONFIG_NAME = (
...
def ensure_native_image_combinations() -> dict[str, list[int]]:
    ...
    try:
        ...
        _ensure_native_image_config(
            db,
            name=NATIVE_IMAGE_5_0_CONFIG_NAME,
